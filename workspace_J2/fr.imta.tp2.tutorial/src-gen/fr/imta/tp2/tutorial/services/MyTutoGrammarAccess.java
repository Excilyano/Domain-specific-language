...
* generated by Xtext
*/
package fr.imta.tp2.tutorial.services;
...
@Singleton
public class MyTutoGrammarAccess extends AbstractGrammarElementFinder {
	
	
	public class MyTutoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MyTuto");
	...
	public class ImportElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cImportedNameSpaceQualifiedNameSpaceWithWildCardParserRuleCall_1_0 = (RuleCall)cImportedNameSpaceAssignment_1.eContents().get(0);
		...
		public RuleCall getImportedNameSpaceQualifiedNameSpaceWithWildCardParserRuleCall_1_0() { return cImportedNameSpaceQualifiedNameSpaceWithWildCardParserRuleCall_1_0; }
	}
	...
	private MyTutoElements pMyTuto;
	...
	@Inject
	public MyTutoGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("fr.imta.tp2.tutorial.MyTuto".equals(grammar.getName())) {
				return grammar;
			}
	...
	//MyTuto:
	//	elements+=AbstractElement*;
	public MyTutoElements getMyTutoAccess() {
		return (pMyTuto != null) ? pMyTuto : (pMyTuto = new MyTutoElements());
	}
	
	public ParserRule getMyTutoRule() {
		return getMyTutoAccess().getRule();
	}
