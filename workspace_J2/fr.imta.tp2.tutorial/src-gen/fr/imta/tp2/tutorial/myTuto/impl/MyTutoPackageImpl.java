...
import fr.imta.tp2.tutorial.myTuto.MyTutoFactory;
 ...
 * @generated
 */
public class MyTutoPackageImpl extends EPackageImpl implements MyTutoPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private EClass myTutoEClass = null;
   ...
   * @see fr.imta.tp2.tutorial.myTuto.MyTutoPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MyTutoPackageImpl()
  {
    super(eNS_URI, MyTutoFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link MyTutoPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MyTutoPackage init()
  {
    if (isInited) return (MyTutoPackage)EPackage.Registry.INSTANCE.getEPackage(MyTutoPackage.eNS_URI);

    // Obtain or create and register package
    MyTutoPackageImpl theMyTutoPackage = (MyTutoPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MyTutoPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MyTutoPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theMyTutoPackage.createPackageContents();

    // Initialize created meta-data
    theMyTutoPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMyTutoPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MyTutoPackage.eNS_URI, theMyTutoPackage);
    return theMyTutoPackage;
  }
   ...
   * @generated
   */
  public EReference getMyTuto_Elements()
  {
    return (EReference)myTutoEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public MyTutoFactory getMyTutoFactory()
  {
    return (MyTutoFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    myTutoEClass = createEClass(MY_TUTO);
    createEReference(myTutoEClass, MY_TUTO__ELEMENTS);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(myTutoEClass, MyTuto.class, "MyTuto", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMyTuto_Elements(), this.getAbstractElement(), null, "elements", null, 0, -1, MyTuto.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
