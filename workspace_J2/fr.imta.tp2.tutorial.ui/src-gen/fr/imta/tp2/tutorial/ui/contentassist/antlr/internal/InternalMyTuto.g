...
entryRuleQualifiedNameSpaceWithWildCard 
:
...
{ before(grammarAccess.getMyTutoAccess().getElementsAbstractElementParserRuleCall_0()); }
	ruleAbstractElement{ after(grammarAccess.getMyTutoAccess().getElementsAbstractElementParserRuleCall_0()); }
)
...
{ before(grammarAccess.getImportAccess().getImportedNameSpaceQualifiedNameSpaceWithWildCardParserRuleCall_1_0()); }
	ruleQualifiedNameSpaceWithWildCard{ after(grammarAccess.getImportAccess().getImportedNameSpaceQualifiedNameSpaceWithWildCardParserRuleCall_1_0()); }
)
