...
/**
 * This is the item provider adapter for a {@link calendardsl.calendarDSL.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_on_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_on_feature", "_UI_Event_type"),
				 CalendarDSLPackage.Literals.EVENT__ON,
				 true,
				 false,
				 false,
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_from_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_from_feature", "_UI_Event_type"),
				 CalendarDSLPackage.Literals.EVENT__FROM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_to_feature", "_UI_Event_type"),
				 CalendarDSLPackage.Literals.EVENT__TO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAtPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_at_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_at_feature", "_UI_Event_type"),
				 CalendarDSLPackage.Literals.EVENT__AT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CalendarDSLPackage.Literals.EVENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
